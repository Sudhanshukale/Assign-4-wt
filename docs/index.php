<!DOCTYPE html>
    ...
    <body >
        <div class="botron text-center"><h1 style="color: white;">Restaurant Menu list</h1></div>
       

        <div class="dem"><h1 style="color: red;"
            >You can choose the item from Menu list and order it !!</h1>
          </div>
          ...
          <table id="table" class="table table-hover" align="centre">
            <tr>
              <th>Name</th>
              <td id="menuname"></td>
            </tr>
